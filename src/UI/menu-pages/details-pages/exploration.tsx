  ...
  return (
    <div className='mt-20 container'>
      ...
      <div className='exploration-story-section blue-border'>
        <img
          src='https://cdn.swisscows.com/image?url=https://tse3.mm.bing.net/th?id=OIP.iuGKlS8RpXDADbShaqvUDAHaEK&pid=Api'
          className='img-responsive'
        ></img>
        <div className='story'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
          ut labore et dolore magna aliqua. Quis viverra nibh cras pulvinar mattis nunc sed. Tortor
          dignissim convallis aenean et tortor at risus. Sagittis vitae et leo duis ut diam quam
          nulla porttitor. Tincidunt tortor aliquam nulla facilisi. Elementum integer enim neque
          volutpat ac tincidunt vitae. Nullam ac tortor vitae purus faucibus ornare. Diam vulputate
          ut pharetra sit amet aliquam id. Facilisi nullam vehicula ipsum a arcu cursus vitae
          congue. Feugiat sed lectus vestibulum mattis. Fermentum iaculis eu non diam phasellus
          vestibulum lorem sed risus. Eu lobortis elementum nibh tellus molestie. Dolor sit amet
          consectetur adipiscing elit ut aliquam. Duis convallis convallis tellus id interdum velit.
